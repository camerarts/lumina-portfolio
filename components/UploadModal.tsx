...
export const UploadModal: React.FC<UploadModalProps> = ({ isOpen, onClose, onUpload, theme, editingPhoto, token }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    setUploadStatus(editingPhoto ? '正在保存修改...' : '正在上传...');
    ...
    const photoData: Photo = {
      id: editingPhoto ? editingPhoto.id : '', // ID is passed to backend for identification
      url: editingPhoto ? editingPhoto.url : '', // Backend handles real URL
      title: title || '未命名作品',
      category: category,
        ...
        <div className="flex-1 overflow-y-auto p-6 pt-2 custom-scrollbar">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            `}>
              ...
              {/* If editing, allow clicking to replace image */}
